...
; (function ($) {
    ...
    $(".dark").on('click', function (e) {
        ...
        $(".tf-text").addClass("s1")
        document.getElementById("logo_header").src = "assets/images/logo/logo_dark.gif";
        document.getElementById("logo_footer").src = "assets/images/logo/logo_dark.gif";
    ...
    $(".light").on('click', function (e) {
        ...
        document.getElementById("logo_header").src = "assets/images/logo/logo_light.gif";
        document.getElementById("logo_footer").src = "assets/images/logo/logo_light.gif";
